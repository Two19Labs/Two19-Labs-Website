...
// Renders the layered "liquid glass" surface. Wrap any children in it.
// Pass `as` to change the rendered element (default: div; nav/header/etc.).
...
// SVG Filter Component — render ONCE per page (it's a global <filter> def).
