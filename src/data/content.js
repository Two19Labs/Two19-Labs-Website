...
export const portfolioProjects = [
  {
    ...
    description: 'Unified internal portal replacing five disconnected spreadsheets.',
    problem: 'The client was managing scheduling, inventory, HR and billing across six separate spreadsheets. Data was constantly out of sync, manual reconciliation took hours each day, and errors were silently compounding.',
    built: 'A single unified portal replacing all six tools — with modules for inventory tracking, staff scheduling, purchase orders, billing, and real-time reporting. Fully owned by the client with no third-party lock-in or per-seat fees.',
  ...
  {
    id: 2,
    title: 'Ghoomar — House of Brands',
    client: 'Ghoomar Thali',
    location: 'Delhi, India',
    year: '2024',
    category: 'Web Development',
    description: 'Full multi-brand digital presence — four sub-sites, one domain.',
    problem: 'Four distinct Ghoomar brands (a traditional restaurant, a 25,000 sq.ft. entertainment village, a multicuisine dining venue, and a travel experience) had no unified web presence. Customers couldn\'t find the right brand, and the team had no central way to manage bookings or payments online.',
    built: 'A full multi-brand domain at ghoomarthali.in with four dedicated sub-sites — each with its own design, content and functionality. 20+ pages total, with payment integration, booking flows, and Google Maps listings across all four brands.',
    result: '4 brands, 1 domain, 20+ pages live',
    tags: ['Web Dev', 'Payment Integration', 'Multi-brand', 'Booking Flows'],
    status: 'live',
    link: 'https://ghoomarthali.in',
    image: '/portfolio/ghoomar-screenshot.png',
  },
  {
    id: 3,
    ...
    description: 'AI sales assistant qualifying and following up leads 24/7.',
    problem: 'The sales team was losing leads because follow-ups were slow and inconsistent. Reps were too busy to respond to every inbound enquiry within the critical first hour, and warm leads were going cold before anyone could reach them.',
    built: 'An AI-powered sales assistant that qualifies inbound leads, books meetings automatically, and sends personalised follow-up sequences — operating 24/7 across email and WhatsApp with zero human intervention for standard cases.',
  ...
  },
  {
    ...
    year: '2024',
    category: 'Web Development',
    description: 'Custom storefront with streamlined checkout and headless CMS.',
    problem: 'The existing storefront had a high cart abandonment rate and a clunky checkout flow. The marketing team also depended on developers to update product pages and run promotions — slowing down every campaign.',
    built: 'A custom-built storefront with a streamlined one-page checkout, live inventory sync, and a headless CMS wired in so the team can publish pages and run campaigns entirely without developer involvement.',
  ...
  },
  {
    ...
    year: '2025',
    category: 'AI & Automation',
    description: 'AI pipeline replacing a multi-person manual document review process.',
    problem: 'A multi-person team was manually reviewing, classifying, and routing incoming documents every day — an error-prone process that created backlogs and delayed every downstream team that depended on it.',
    built: 'An end-to-end AI pipeline that ingests documents, classifies them by type, extracts key fields, and routes them to the right team automatically. Human review is only triggered for edge cases that fall outside defined confidence thresholds.',
  ...
  },
  {
    ...
    description: 'Real-time dashboard unifying four data sources for leadership.',
    problem: 'Leadership was making decisions based on reports pulled manually from four disconnected tools. By the time the numbers were compiled and shared, they were already out of date — and the process ate hours of analyst time each week.',
    built: 'A live operations dashboard pulling from all four data sources in real time — giving leadership a single view of KPIs, orders, and financials with date range filtering, drill-down, and automatic refresh.',
  ...
  {
    id: 8,
    title: 'Gawdaam — Restaurant ERP',
    client: 'Gawdaam',
    location: 'India',
    year: '2025',
    category: 'Custom Software',
    description: 'Personalised ERP for restaurants — stock, billing, analytics in one system.',
    problem: 'Restaurant operators were juggling stock tracking, purchase bills, inventory alerts, and analytics across disconnected tools — with no single view of what was actually happening in their kitchen and store. Generic SaaS tools required workarounds that created more gaps than they closed.',
    built: 'A fully personalised ERP for restaurants — stock dashboard, purchase bill management, stock ledger, wastage tracking, order management, and real-time spend analytics. Every deployment is bespoke to that restaurant\'s exact workflow, not the other way around.',
    result: 'End-to-end ops managed in one system',
  ...
  {
    id: 7,
    title: 'ITC Aashirvaad — Meri Chakki Kiosk',
    client: 'ITC Aashirvaad',
    location: 'India',
    year: '2024',
    category: 'Internal Tools',
    description: 'In-store bilingual kiosk UI recommending the right atta for each customer.',
    problem: 'ITC Aashirvaad needed an in-store digital touchpoint to guide customers to the right Meri Chakki product — but no off-the-shelf tool matched the brand, the product complexity, or the need to serve customers in both English and Hindi.',
    built: 'A bilingual touch-screen kiosk UI that walks customers through a personalised 4-step survey — family size, age groups, selection method, and wellness goals — then recommends the right Meri Chakki atta product for their household. Designed for retail store deployment.',
    result: 'Full kiosk flow shipped for in-store deployment',
    tags: ['React', 'Kiosk UI', 'Touch UX', 'Bilingual'],
    status: 'live',
    image: '/portfolio/aashirvad.png',
  },
]
